...
Suport will be provided based on my own needs, but you can open a ticket or send a email with the error, and I can try to update this extension and fix it.
Feel free to make pull-requests of sugestions.
